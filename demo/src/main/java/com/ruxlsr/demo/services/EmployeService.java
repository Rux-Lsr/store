...
import com.ruxlsr.demo.repositories.EmployeRepository;
...
public class EmployeService {
    ...
    public Employe updateEmploye(UUID id, Employe updatedEmploye) {
        return employeRepository.findById(id).map(
                existingEmploye -> {
                    ...
                    existingEmploye.setDepartment(updatedEmploye.getDepartment());
    ...
    public void deleteEmploye(UUID id) {
        if (!employeRepository.existsById(id)) {throw new EntityNotFoundException("L'employé avec id " + id +
                    " n'existe pas !");
